...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === 'running') {
            ...
            if (!validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert(`One or more of the inputs is not a positive number!`);
        ...
        if (type === 'cycling') {
            ...
            // Check if data is valid
            // Guard clause (chexking for the oposite of the actual condition)
            if (!validInputs(distance, duration, elevation) || !allPositive(distance, duration)) return alert(`One or more of the inputs is not a positive number!`);
            // Create new running object
